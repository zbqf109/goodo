...
'''werkzeug's routing is a powerful module. But here I need a less featured version:
1. Map and Rule strip out host, subdomain
2. Their `match` methods do no trick and more like the re.match function
'''
...
url_join = lambda x,y: x + '/' + y

from openerp.fake_werkzeug._compat import itervalues, iteritems, to_unicode, to_bytes, \
...
class Rule(RuleFactory):
    ...
    def __init__(self, string, defaults=None, subdomain=None, methods=None,
                 ...
                 redirect_to=None, alias=False, prefix=None):
    ...
    def compile(self):
        ...
        if self.prefix:
            regex = u'^{}{}'.format(self.prefix, regex)
        else:
            regex = u'^' + regex
...
class Map(object):
    ...
    default_converters = dict(DEFAULT_CONVERTERS)

    def __init__(self, rules=None, charset='utf-8',
    ...
    def bind(self, script_name=None,
        ...
        """
        return MapAdapter(self, script_name,
    ...
    def bind_to_environ(self, environ, server_name=None, subdomain=None):
        ...
        return Map.bind(self, script_name,
...
class MapAdapter(object):
    ...
    def __init__(self, map, script_name,
    ...
    def match(self, path_info=None, method=None, return_rule=False,
        ...
        raise Exception('Not found: ' + path_info)
